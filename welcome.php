...
if (isset($_POST['SUBMIT'])){
        ...
        $sqli = "INSERT INTO applicants_form(name,mobile,date_birth,address,father,district,gender,state) VALUES('$name','$mobile','$date_birth','$address','$father','$district','gender','state')";
